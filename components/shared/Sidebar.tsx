                        ...
                        {navLinks.slice(0, 2).map((link, index) => {
                            ...
                            return (
                                <li 
                                    ...
                                    <Link href={link.route} className='text-sm group flex p-3 w-full justify-start font-medium cursor-pointer hover:text-slate-400 hover:bg-white/10 rounded-lg transition'>
